    ...
    <body>
        <div id="menu">
            ...
            <ul>
                ...
                <li id="A033" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#033">用户清单列表[v1.2.1]</a>
                </li>
                <li id="A034" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#034">用户添加清单[v1.2.1]</a>
                </li>
                <li id="A035" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#035">添加清单商品[v1.2.1]</a>
                </li>
                <li id="A036" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#036">编辑清单备注[v1.2.1]</a>
                </li>
                <li id="A037" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#037">操作清单商品排序[v1.2.1]</a>
                </li>
                <li id="A038" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#038">用户清单详情列表[v1.2.1]</a>
                </li>
                <li id="A039" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#039">删除用户清单[v1.2.1]</a>
                </li>
                <li id="A040" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#040">视频列表接口[v1.2.2]</a>
                </li>
                <li id="A041" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#041">视频详情接口[v1.2.2]</a>
                </li>
                <li id="A042" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#042">首页菜单接口[v1.2.2]</a>
                </li>
                <li id="A043" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#043">启动页接口[v1.2.3]</a>
                </li>
                <li id="A044" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#044">话题详情接口[v1.2.3]</a>
                </li>
                <li id="A045" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#045">话题列表接口[v1.2.3]</a>
                </li>
                <li id="A046" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#046">贴子详情接口[v1.2.3]</a>
                </li>
                <li id="A047" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#047">发帖接口[v1.2.3]</a>
                </li>
                <li id="A048" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#047">话题帖点赞[v1.2.3]</a>
                </li>
                ...
                <li id="U1033" onclick="document.getElementById(currentItem).className = ''; currentItem = this.id; this.className = 'current';">
                    <a href="#1033">今天买什么[v1.2.2]</a>
                </li>
        ...
        <div id="content">
            ...
            <p>附加说明：</p>
                ...
                <li><span><b>menu(array)</b>  － 菜单栏目</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>id(int)</b>            － ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>title(string)</b>      － 标题</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>subtitle(string)</b>   － 子标题</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>img(string)</b>        － 图片</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>type(int)</b>          － 1为产品库，2为我在用，3为买什么，4为AVI，5为批号查询，6为福利</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>additional(array)</b>  － 附加信息[type为3,4,6存在数据]</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>id(int)</b>  － 对应ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>thumb_img(string)</b>  － 图</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>name(string)</b>  － 标题</span></li>
                <li><span><b>articleGory(array)</b>  － 文章栏目</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>id(int)</b>            － ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>cate_name(string)</b>  － 栏目名</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>cate_img(string)</b>   － 配图</span></li>

                <li><span><b>videosList(array)</b>  － 视频列表</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>id(int)</b>            － ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>title(string)</b>      － 标题</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>thumb_img(string)</b>  － 缩略图</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>username(string)</b>   － 用户名【颜究院】</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>headerImg(string)</b>  － 头像【颜究院头像】</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>duration(string)</b>   － 时长【分:秒】</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>relation(string)</b>   － 关联的ID或URL</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>linkUrl(string)</b>    － 分享地址</span></li>
            ...
            <p>附加说明：</p>
                ...
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>like_num(int)</b>      － 点赞数</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>comment(string)</b>    － 评论内容</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>attachment(array)</b>  － 评论附件图[多图集合]</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>isLike(int)</b>        － 是否已点赞</span></li>
            ...
            <p>附加说明：</p>
                ...
                <li><span><b>userProduct(array)</b> － 最新用户在用</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>id(int)</b>            － ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>img(string)</b>        － 产品图</span></li>
                ...
                <li><span><b>bonus(array)</b>           － 优惠券信息</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>product_id(int)</b>    － 商品id</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>bonus_url(string)</b>  － 优惠券链接</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>price(string)</b>      － 优惠券价格</span></li>
            ...
            <ul>
                ...
                <li><span><b>type(int)</b>          － 类型 1-产品，2-文章,3-视频</span></li>
            ...
            <ul>
                ...
                <li><span><b>type(int)</b>          － 1为产品，2为文章,3为视频,4为话题</span></li>
                <li><span><b>id(int)</b>            － 对应ID</span></li>
                <li><span><b>star(int)</b>          － 星级(文章可不传)</span></li>
                <li><span><b>parent_id(int)</b>     － 上级评论ID，一级可传0或不传</span></li>
                <li><span><b>attachment(array)</b>  － 附件图片地址以数组方式上传多张[存放路径为uploads/attachment]</span></li>
                <li><span><b>comment(string)</b>    － 评论内容</span></li>
            </ul>
            <p>调用结果：</p>
                <ul>
            ...
            <ul>
                ...
                <li><span><b>brand_id(int)</b>      － 品牌ID</span></li>
                <li><span><b>product_id(int)</b>      － 产品ID</span></li>
                <li><span><b>up_id(int)</b>         － 用户在用的记录ID(更新时传此id判断)</span></li>
                ...
                <li><span><b>quality_time(int)</b>  － 开封后保质期  -- 保质期，单位为月（和天数二选一）</span></li>
                <li><span><b>days(int)</b>          － 开封后保质期  -- 保质期，单位为天</span></li>
            ...
            <p>附加说明：</p>
                ...
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>product_img(string)</b>    － 产品图</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>coupon_price(int)</b>   － 优惠券金额</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>coupon_link(string)</b>   － 优惠券链接</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>pageTotal(int)</b>         － 总数</span></li>
            ...
            <ul>
                ...
                <li><span><b>id(int)</b>            － 对应ID</span></li>
                <li><span><b>type(string)</b>       － 1为产品，2为文章 3为视频</span></li>
            </ul>
            <p>调用结果：</p>
                <ul>
                    <li><span>失败返回{status:0,msg:处理失败}</span></li>
...
<!--                 <li><span><b>ask(array)</b>  － 用户提问产品</span></li>
            ...
            <p>附加说明：</p>
                <li><span><b>id(int)</b>              － 评论ID</span></li>
                <li><span><b>type(int)</b>            － 1-产品，2-文章 3 视频 4话题</span></li>
            ...
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值userInventoryList</span></li>
                <li><span><b>page(int)</b>          － 当前页数</span></li>
                <li><span><b>pageSize(int)</b>      － 每页多少条</span></li>
            </ul>
            <p>附加说明：</p>
                <li><span><b>id(int)</b>                － 清单ID</span></li>
                <li><span><b>title(string)</b>          － 清单名</span></li>
                <li><span><b>picture(string)</b>        － 清单图</span></li>
                <li><span><b>num(int)</b>               － 产品数</span></li>
            ...
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值addInventory</span></li>
                <li><span><b>user_id(int)</b>       － 用户ID</span></li>
                <li><span><b>title(string)</b>      － 标题</span></li>
                <li><span><b>productId(int)</b>     － 产品ID[可不填]</span></li>
                <li><span><b>desc(string)</b>       － 描述[可不填]</span></li>
            </ul>
            <p>调用结果：</p>
                <ul>
                    <li><span>失败返回{status:0,msg:处理失败}</span></li>
                    <li><span>成功返回{status:1,msg:处理成功,inventoryId:清单ID}</span></li>
                </ul>
            <!---------------------------------------------用户添加清单商品 ----------------------------------------------------- -->
            <h3 id="035">用户添加清单商品</h3>
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值addInventoryProduct</span></li>
                <li><span><b>user_id(int)</b>       － 用户ID</span></li>
                <li><span><b>inventoryId(int)</b>   － 清单ID</span></li>
                <li><span><b>productId(int)</b>     － 产品ID</span></li>
                <li><span><b>desc(string)</b>       － 描述</span></li>
            </ul>
            <p>调用结果：</p>
                <ul>
                    <li><span>失败返回{status:0,msg:处理失败}</span></li>
            ...
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值operateInDetail</span></li>
                <li><span><b>uip_id(int)</b>        － 清单详情的记录id</span></li>
                <li><span><b>type(int)</b>          － 类型1编辑2删除</span></li>
                <li><span><b>desc(string)</b>       － 描述（编辑时输入）</span></li>
            </ul>
            <p>调用结果：</p>
                <ul>
                    <li><span>失败返回{status:0,msg:处理失败}</span></li>
            ...
            <!---------------------------------------------操作清单详情的顺序 ----------------------------------------------------- -->
            <h3 id="037">操作清单详情的顺序</h3>
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值operateInOrder</span></li>
                <li><span><b>uip_ids(string)</b>    － 清单的所有产品记录id（用英文逗号隔开）</span></li>
            </ul>
            <p>调用结果：</p>
                <ul>
                    <li><span>失败返回{status:0,msg:处理失败}</span></li>
            ...
            <!---------------------------------------------用户清单详情列表 ----------------------------------------------------- -->
            <h3 id="038">用户清单详情列表</h3>
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值userInventoryDetail</span></li>
                <li><span><b>invent_id(int)</b>     － 清单id</span></li>
                <li><span><b>page(int)</b>          － 当前页数</span></li>
                <li><span><b>pageSize(int)</b>      － 每页多少条</span></li>
            </ul>
            <p>附加说明：</p>
                <li><span><b>id(int)</b>                － 清单产品记录ID</span></li>
                <li><span><b>product_id(int)</b>        － 产品ID</span></li>
                <li><span><b>desc(int)</b>              － 清单产品记录备注</span></li>
                <li><span><b>product_name(string)</b>   － 产品名</span></li>
                <li><span><b>product_img(string)</b>    － 产品图</span></li>
                <li><span><b>price(int)</b>             － 产品数</span></li>
                <li><span><b>form(int)</b>              － 添加时间</span></li>
                <li><span><b>star(int)</b>              － 添加时间</span></li>
                <li><span><b>pageTotal(int)</b>         － 总条数</span></li>
                <li><span><b>pageSize(int)</b>          － 当前页数</span></li>
            <!---------------------------------------------删除用户清单 ----------------------------------------------------- -->
            <h3 id="039">删除用户清单</h3>
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值delInventory</span></li>
                <li><span><b>user_id(int)</b>       － 用户ID</span></li>
                <li><span><b>inventoryId(int)</b>   － 清单ID</span></li>
            </ul>
            <p>调用结果：</p>
            ...
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值videosList</span></li>
                <li><span><b>page(int)</b>          － 当前页数</span></li>
                <li><span><b>pageSize(int)</b>      － 每页多少条</span></li>
            </ul>
            <p>调用结果：</p>
            ...
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值videoInfo</span></li>
                <li><span><b>id(int)</b>            － 视频id</span></li>
            </ul>
            <p>附加说明：</p>
                <li><span><b>id(int)</b>            － ID</span></li>
                <li><span><b>title(string)</b>      － 标题</span></li>
                ...
                <li><span><b>duration(string)</b>   － 时长【分:秒】</span></li>
                <li><span><b>desc(string)</b>       － 描述</span></li>
                <li><span><b>video(string)</b>      － 视频文件地址</span></li>
                <li><span><b>products(array)</b>    － 关联产品</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>id(int)</b>                － ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>product_name(string)</b>   － 产品名</span></li>  
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>price(float)</b>           － 价格</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>form(string)</b>           － 规格</span></li>
            ...
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值getAppMenu</span></li>
            </ul>
            <p>附加说明：</p>
                <li><span><b>id(int)</b>            － ID</span></li>
                <li><span><b>title(string)</b>      － 标题</span></li>
            ...
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值getStartup</span></li>
            </ul>
            <p>附加说明：</p>
                <li><span><b>id(int)</b>            － ID</span></li>
                <li><span><b>type(int)</b>          － 类型：0：H5 ，1：产品详情 ， 2：文章详情，3：视频详情，4：话题详情</span></li>
                <li><span><b>url(string)</b>        － 地址，当type为0.使用此参数</span></li>
                <li><span><b>img(string)</b>        － 图片</span></li>
                <li><span><b>relation_id(int)</b>   － type除0外。对应的ID</span></li>
                <li><span><b>start_time(int)</b>    － 开始时间</span></li>
                <li><span><b>end_time(int)</b>      － 结束时间</span></li>
            <!---------------------------------------------话题详情接口 ----------------------------------------------------- -->
            <h3 id="044">话题详情接口</h3>
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值topicInfo</span></li>
                <li><span><b>id(int)</b>            － 话题ID</span></li>
                <li><span><b>userId(int)</b>        － 用户ID</span></li>
                <li><span><b>page(int)</b>          － 当前页</span></li>
                <li><span><b>pageSize(int)</b>      － 每页数</span></li>
            </ul>
            <p>附加说明：</p>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>id(int)</b>            － 话题ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>title(string)</b>      － 标题</span></li>
                ...
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>share_pic(string)</b>  － 分享图片</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>linkUrl(int)</b>       － 分享地址</span></li>
                <li><span><b>postList(array)</b>    － 话题帖列表</span></li>
                <li><span><b>&nbsp;&nbsp;&nbsp;&nbsp;id(int)</b>            － 话题帖ID</span></li>
                <li><span><b>&nbsp;&nbsp;&nbsp;&nbsp;user(array)</b>        － 用户信息</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>username(string)</b>  － 用户名</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>user_id(int)</b>      － 用户ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>user_img(string)</b>  － 用户头像</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>topic_id(string)</b>   － 话题ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>content(string)</b>    － 内容</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>like_num(int)</b>      － 点赞数</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>isLike(int)</b>        － 是否已点赞</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>created_at(string)</b> － 创建时间</span></li>
                ...
                <li><span><b>pageSize(int)</b>      － 每页条数</span></li>
            <!---------------------------------------------话题帖列表接口 ----------------------------------------------------- -->
            <h3 id="045">话题帖列表接口</h3>
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值postList</span></li>
                <li><span><b>id(int)</b>            － 话题ID</span></li>
                <li><span><b>orderBy(int)</b>       － 1为时间，2为点赞数【倒序】</span></li>
                <li><span><b>page(int)</b>          － 当前页</span></li>
                <li><span><b>pageSize(int)</b>      － 每页数</span></li>
            </ul>
            <p>附加说明：</p>
                <li><span><b>id(int)</b>            － 话题帖ID</span></li>
                <li><span><b>user(array)</b>        － 用户信息</span></li>
                <li><span><b>picture(string)</b>    － 封面图</span></li>
                <li><span><b>ratio(float)</b>       － 封面图比例</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>username(string)</b>  － 用户名</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>user_id(int)</b>      － 用户ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>user_img(string)</b>  － 用户头像</span></li>
                <li><span><b>topic_id(string)</b>   － 话题ID</span></li>
                ...
                <li><span><b>created_at(string)</b> － 创建时间</span></li>
            <!---------------------------------------------话题帖详情接口 ----------------------------------------------------- -->
            <h3 id="046">话题帖详情接口</h3>
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值postInfo</span></li>
                <li><span><b>id(int)</b>            － 话题ID</span></li>
            </ul>
            <p>附加说明：</p>
                <li><span><b>id(int)</b>            － 话题帖ID</span></li>
                ...
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>skin(string)</b>        － 用户肤质</span></li>
                <li><span><b>topic_id(string)</b>   － 话题ID</span></li>
                <li><span><b>title(string)</b>      － 话题标题</span></li>
                <li><span><b>content(string)</b>    － 内容</span></li>
                <li><span><b>like_num(int)</b>      － 点赞数</span></li>
                <li><span><b>attachment(array)</b>  － 图片</span></li>
                <li><span><b>isLike(int)</b>        － 是否已点赞</span></li>
                <li><span><b>linkUrl(int)</b>       － 分享地址</span></li>
                <li><span><b>created_at(string)</b> － 创建时间</span></li>
                <li><span><b>commentList(array)</b> － 评论</span></li>
            ...
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值addPost</span></li>
                <li><span><b>id(int)</b>            － 话题ID</span></li>
                <li><span><b>userId(int)</b>        － 用户ID</span></li>
                <li><span><b>picture(string)</b>    － 封面图</span></li>
                <li><span><b>ratio(float)</b>       － 封面图比例</span></li>
                <li><span><b>attachment(array)</b>  － 图片集</span></li>
                <li><span><b>content(string)</b>    － 内容</span></li>
            </ul>
            <p>附加说明：</p>
                <li><span>失败返回{status:0,msg:处理失败}</span></li>
                <li><span>成功返回{status:1,msg:以下参数}</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>postId(int)</b>        － 新建帖子ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>attachment(array)</b>  － 图片地址集合</span></li>
            <!-- ---------------------------------------------话题帖点赞接口--------------------------------------------------- -->
            <h3 id="048">话题贴点赞接口</h3>
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>     － 固定值addPostLike</span></li>
                <li><span><b>postId(int)</b>        － 话题帖ID</span></li>
            </ul>
            <p>调用结果：</p>
                <ul>
                    <li><span>失败返回{status:非1,msg:错误信息}</span></li>
            ...
            <p>附加说明：</p>
                ...
                <li><span>&nbsp;&nbsp;&nbsp;&nbsp;以下为视频详情</span></li>
                <li><span><b>id(int)</b>            － 对应ID</span></li>
                <li><span><b>name(string)</b>       － 名称</span></li>
                <li><span><b>img(string)</b>        － 图片</span></li>
                <li><span>&nbsp;&nbsp;&nbsp;&nbsp;以下为话题详情</span></li>
                <li><span><b>id(int)</b>            － 对应ID</span></li>
                <li><span><b>post_title(string)</b> － 帖子名称</span></li>
                <li><span><b>topic_title(string)</b>－ 话题名称</span></li>
                <li><span><b>post_img(array)</b>    － 话题图片</span></li>
                <li><span><b>img_num(array)</b>     － 话题图片数量</span></li>
                <li><span><b>created_at(string)</b> － 话题创建时间</span></li>
            <!-- ---------------------------------------------用户消息  ----------------------------------------------- -->
            <h3 id="1007">用户消息</h3>
            <p>调用参数：</p>
            <ul>
            ...
            <p>附加说明：</p>
                ...
                <li><span><b>type(string)</b>           － 消息类型 （1 用户消息 2 系统消息 3 提问消息 4 提问消息回复 5用户回复评论 6问答评论点赞 7话题帖子点赞 ）</span></li>
                <li><span><b>otype(string)</b>          － 类型 （0系统消息  1 产品 2 文章 3评论 4后台回复消息 5视频 6话题)</span></li>
                <li><span><b>is_delete(int)</b>         － 是否删除 （0未删  1 已删)</span></li>
            <!-- ---------------------------------------------用户重置密码  ----------------------------------------------- -->
            ...
            <ul>
                ...
                <li><span><b>order(int)</b>             － 排序类型，0为时间，1保质期</span></li>
                <li><span><b>page(int)</b>              － 当前页数</span></li>
                <li><span><b>pageSize(string)</b>       － 每页多少条</span></li>
            </ul>
            <p>附加说明：</p>
                <li><span><b>id(int)</b>       － 用户在用的记录ID(更新时需要用到此id判断)</span></li>
                <li><span><b>user_id(int)</b>       － 用户ID</span></li>
                <li><span><b>brand_id(int)</b>      － 品牌ID</span></li>
                <li><span><b>product_id(int)</b>      － 产品ID</span></li>
                <li><span><b>brand_name(string)</b> － 品牌名</span></li>
                ...
                <li><span><b>img(string)</b>        － 图片地址</span></li>
                <li><span><b>is_seal(int)</b>       － 是否开封,0未开封，1已开封</span></li>
                <li><span><b>remain_days(int)</b>   － 剩余天数（过期固定返回-1）</span></li>
                <li><span><b>seal_time(int)</b>     － 开封时间</span></li>
                <li><span><b>quality_time(int)</b>  － 开封后保质期  -- 保质期，单位为月</span></li>
                <li><span><b>overdue_time(int)</b>  － 过期时间</span></li>
                <li><span><b>expire_time(int)</b>   － 到期时间</span></li>
                <li><span><b>add_time(int)</b>      － 添加时间</span></li>
                <li><span><b>has_rule(int)</b>      － 是否有批号规则（1有0没有）</span></li>
            <!-- ---------------------------------------------操作用户在用信息  ----------------------------------------------- -->
            ...
            <p>附加说明：</p>
                ...
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>img(string)</b>    － 配图</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>hot(int)</b>       － 热度</span></li>
                <li><span><b>brand(array)</b>           － 成份列表</span></li> 
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>id(int)</b>        － 成份ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>name(string)</b>   － 成份名</span></li>
                ...
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>star(int)</b>              － 星级</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>comment_num(int)</b>       － 评论数</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>tags(array)</b>            － 标签</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>itemid(int)</b>        － 标签ID</span></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>tagname(string)</b>    － 标签名称</span></li>
            ...
            <p>附加说明：</p>
                ...
                <li><span><b>created_at(int)</b>        － 时间</span></li>
                <li><span><b>content(string)</b>        － 内容</span></li>
                <li><span><b>type(string)</b>           － 类型（1 产品评论 2 文章评论 3 产品提问 4 视频回复 5 话题回复）</span></li>  
            <!-- ---------------------------------------------提问接口  ----------------------------------------------- -->
            ...
            <!-- ---------------------------------------------今天买什么接口  ----------------------------------------------- -->
            <h3 id="1033">今天买什么列表</h3>
            <p>调用参数：</p>
            <ul>
                <li><span><b>action(string)</b>         － 固定值buyToday</span></li>
                <li><span><b>page(int)</b>              － （非必填）当前页数</span></li>
                <li><span><b>pageSize(string)</b>       － （非必填）每页多少条</span></li>
            </ul> 
            <p>附加说明：</p>
                <li><span><b>nick(string)</b>          － 淘宝店名</span></li>
                <li><span><b>pict_url(string)</b>      － 商品图标</span></li>
                <li><span><b>title(string)</b>         － 商品标题</span></li>
                <li><span><b>zk_final_price(float)</b> － 商品价格</span></li>
                <li><span><b>price(float)</b>          － 优惠券价格</span></li>
                <li><span><b>link(string)</b>          － 链接(当有优惠券价格时为优惠券链接，否则为商品链接)</span></li>
            <!-- ---------------------------------------------公共参数--------------------------------------------------- -->
            ...
            <ul>
                ...
                <li><span><b>token(string)</b>  － TOKEN[有登录就传。未登录传空]</span></li>
            </ul>
            <!-- ---------------------------------------------公共返回值--------------------------------------------------- -->
            <h3 id="z">公共返回值</h3>
            <ul>
                ...
                <li><span><b>-23</b>    －  (全局)百科不存在</span></li>
                <li><span><b>-24</b>    －  (全局)清单不存在</span></li>
                <li><span><b>-25</b>    －  (全局)产品在清单中</span></li>
                <li><span><b>-26</b>    －  (全局)视频不存在</span></li>
                <li><span><b>-27</b>    －  (全局)话题不存在</span></li>
                <li><span><b>-28</b>    －  (全局)话题帖不存在</span></li>
