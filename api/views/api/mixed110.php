    ...
    <body>
        ...
        <div id="content">
            ...
            <p>附加说明：</p>
                ...
                <li>&nbsp;&nbsp;&nbsp;&nbsp;<span><b>star(int)</b>             － 产品星级</span></li>
            ...
            <p>调用结果：</p>
                <ul>
                    <li><span>失败返回{status:非1,msg:错误信息}</span></li>
                    <li><span>成功返回{status:1,msg:提示信息,commentId: 生成的评论ID,attachment:图片地址}</span></li>
                </ul>
            <!-- ---------------------------------------------批号查询列表接口--------------------------------------------------- -->
            <h3 id="007">品牌列表接口</h3>
            <p>调用参数：</p>
            ...
            <p>附加说明：</p>
                ...
                <li><span><b>type(string)</b>           － 消息类型 （1 用户消息 2 系统消息 3 提问消息 4 提问消息回复）</span></li>
