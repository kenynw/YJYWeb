...
$(function(){
  ...
  function upSuccess(data) {
    if(data.filename){
	    ...
	    var id = 'upload_img_'+$(".add-pic-list li").length;
	    var img_obj='<li class="img_file_li" id="'+id+'"><a><input type="text" id="post-views_num" class="form-control" name="VoteCreate[pic_list][]" value="'+data.filename+'" style="display:none;"><img src="'+showUrl+data.filename+'" data="'+showUrl+data.filename+'" style="width:100px;height:100px;" alt=""  class="images" id="image'+len+'" data-key ="'+len+'" data-toggle="modal" data-target="#file"><i class="icon-close" onclick=removeImg($("#'+id+'"))></i></a></li>';
