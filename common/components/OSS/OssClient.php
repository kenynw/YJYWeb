...
require_once 'OSS/Model/CorsConfig.php';
require_once 'OSS/Model/CnameConfig.php';
require_once 'OSS/Model/LoggingConfig.php';
require_once 'OSS/Result/AclResult.php';
require_once 'OSS/Result/BodyResult.php';
require_once 'OSS/Result/GetCorsResult.php';
require_once 'OSS/Result/GetLifecycleResult.php';
require_once 'OSS/Result/GetLoggingResult.php';
require_once 'OSS/Result/GetRefererResult.php';
require_once 'OSS/Result/GetWebsiteResult.php';
require_once 'OSS/Result/GetCnameResult.php';
require_once 'OSS/Result/HeaderResult.php';
require_once 'OSS/Result/InitiateMultipartUploadResult.php';
require_once 'OSS/Result/ListBucketsResult.php';
require_once 'OSS/Result/ListMultipartUploadResult.php';
require_once 'OSS/Model/ListMultipartUploadInfo.php';
require_once 'OSS/Result/ListObjectsResult.php';
require_once 'OSS/Result/ListPartsResult.php';
require_once 'OSS/Result/PutSetDeleteResult.php';
require_once 'OSS/Result/ExistResult.php';
require_once 'OSS/Result/AppendResult.php';
require_once 'OSS/Model/ObjectListInfo.php';
require_once 'OSS/Result/UploadPartResult.php';
require_once 'OSS/Model/BucketListInfo.php';
require_once 'OSS/Model/LifecycleConfig.php';
require_once 'OSS/Model/RefererConfig.php';
require_once 'OSS/Model/WebsiteConfig.php';
require_once 'OSS/Core/OssUtil.php';
require_once 'OSS/Model/ListPartsInfo.php';
