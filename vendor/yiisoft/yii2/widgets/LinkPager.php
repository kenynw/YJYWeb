...
class LinkPager extends Widget
{
    ...
    protected function renderPageButtons()
    {
        ...
        if($this->pages){
            $buttons[] = "<li>".Html::dropDownList('pages', $this->pages, [5=>5,10=>10,15=>15,20=>20,25=>25] ,["style"=>'width:45px;height:35px;margin:0px 20px;border-radius: 4px;float:left;']) ."</li>";
        }
        ...
        for ($i = $beginPage; $i <= $endPage; ++$i) {
            $cur_label = $this->mPageCss !== false ? '第'.($i + 1).'页' : $i + 1;
            $buttons[] = $this->renderPageButton($cur_label, $i, null, false, $i == $currentPage);
        }
