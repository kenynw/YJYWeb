...
//        $this->stateMap['ERROR_TYPE_NOT_ALLOWED'] = iconv('unicode', 'utf-8', $this->stateMap['ERROR_TYPE_NOT_ALLOWED']);
    ...
    private function upFile()
    {
        ...
        $this->fileWidth = @getimagesize($file["tmp_name"])[0];
        ...
        $upload->upload($file["tmp_name"],$this->fullName);
...
//        }
    ...
    {
        $url = str_replace("cs/",'',$this->fullName);
        $url = str_replace("uploads/",'',$url);

        return array(
            "state"    => $this->stateInfo,
            "url"      => $url,//替换返回的地址，让前台图片能够在后台正常显示
            "title"    => $this->fileName,
